 ...
 */
package com.wl4g.escg.fault.config;

import org.springframework.boot.context.properties.ConfigurationProperties;
import org.springframework.context.annotation.Bean;

import com.wl4g.escg.constant.EscgConstants;
import com.wl4g.escg.fault.FaultInjectorFilterFactory;
...
public class FaultAutoConfiguration {
    ...
    @Bean
    @ConfigurationProperties(prefix = EscgConstants.CONF_PREFIX_ESCG_FAULT)
