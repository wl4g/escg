...
import com.wl4g.escg.security.sign.SimpleSignAuthingFilterFactory;
import com.wl4g.escg.security.sign.event.DefaultRedisSignAuthingEventRecoder;
...
public class IamSecurityAutoConfiguration {
    ...
    @Bean
    @ConfigurationProperties(prefix = EscgConstants.CONF_PREFIX_ESCG_SECURITY)
