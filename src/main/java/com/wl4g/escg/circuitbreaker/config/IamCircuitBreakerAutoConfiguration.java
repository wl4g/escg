 ...
 */
package com.wl4g.escg.circuitbreaker.config;
...
import com.wl4g.escg.circuitbreaker.DefaultCircuitBreakerCustomizer;
import com.wl4g.escg.circuitbreaker.IamSpringCloudCircuitBreakerResilience4JFilterFactory;
...
public class IamCircuitBreakerAutoConfiguration {
    ...
    @Bean
    @ConfigurationProperties(prefix = EscgConstants.CONF_PREFIX_ESCG_CIRCUITBREAKER)
